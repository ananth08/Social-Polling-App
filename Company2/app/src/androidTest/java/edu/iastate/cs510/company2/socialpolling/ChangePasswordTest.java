...
public class ChangePasswordTest {
    ...
    public void changePasswordWithEmptyFields() throws Exception{
        onView(withId(R.id.btn_changePwd))      // withId(R.id.my_view) is a ViewMatcher
                .perform(click(), closeSoftKeyboard())     // click() is a ViewAction
                .check(matches(isDisplayed())); // Ensures that activity hasn't changed

    }

   /* @Test
    public void changePasswordIncorrectMail() throws Exception{
        ...
        onView(withId(R.id.input_email_id))
                .perform(typeText(user.getEmail()+ "hi"),closeSoftKeyboard());
        ...
        ChangePasswordActivity activity = cpActivityRule.getActivity();
        onView(withText("Your email is not registered, please register first.")).
